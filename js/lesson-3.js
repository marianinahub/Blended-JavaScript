...
// console.log(numbersArray) // [4, 2, 5, 1, 3]
...
// console.log(stringArray) // ['banana', 'orange', 'apple', 'pear']
...
// console.log(users) // [{ name: 'John', age: 27 }, { name: 'Jane', age: 31 }, { name: 'Bob', age: 19 }]
...
//console.log(client.email); // mango@gmail.com
//client.email = 'poly@gmail.com';
...
//Завдання 13
  ...
  // Крім того, клас `Employee` має мати метод `getEmployeeDetails()`, який повертає об'єкт з зарплатою співробітника та відділом, в якому він працює.
    ...
    //const employee = new Employee('Jane', 28, 'female', 'jane@gmail.com', 50000, 'IT');   
